...
## Quiz - Pregunta 2
'¿Cuál de estos métodos de búsqueda de un elemento en una lista es más eficiente?', 'Búsqueda lineal', 'Búsqueda binaria'
...
## Quiz - Pregunta 6
'Dados dos vértices u y v de un árbol enraizado. ¿Qué proposición es equivalente a afirmar que existe un camino que empieza en v y acaba en u?', 'v es padre de u', 'u es descendiente de v'
...
## Pantalla 1.1.1.1: Llamar al dueño del edificio
**[Ruta xokas]**

Te sientes indignado por la falta de agua caliente y decides llamar al dueño del apartamento para reclamarle. Esperas unos segundos hasta que te contesta una voz ronca y somnolienta.\n"¿Qué?" te contesta el dueño con evidente molestia, sin esperar mucho de esta llamada intempestiva.

## Pantalla 1.1.1.1.1: Soy yo, man
"¡Tell me what you want!" te increpa el dueño con impaciencia.

## Pantalla 1.1.1.1.1.1: No tengo agua caliente
"Me suda la polla" te contesta el dueño, dejándote momentáneamente paralizado ante su falta de empatía.

## Pantalla 1.1.1.1.1.1.1: Me tenés que ayudar
...
## Pantalla 1.1.1.1.1.1.1.1: Es tu edificio, hacete cargo
"¡Qué quieres que haga!" te exige, mientras tu cuerpo continúa absorbiendo el calor de su ambiente.

## Pantalla 1.1.1.1.1.1.1.1.1: Solucioname el tema del agua
...
## Pantalla 1.1.2.1.1: Intentar salvar el café
...
## Pantalla 1.1.2.2.2: Buscar *señales*
Un aura de misterio envuelve la habitación, puedes sentirla como una sombra que te susurra secretos olvidados. Instintivamente, tu mirada se eleva hacia el techo, donde una lámpara cuelga, derramando su tenue luz en cascada. Parece observarte, pero pronto te das cuenta de que su mirada fluye a través de ti como si no fueras más que una superficie suave con dos lados. De repente, tus ojos encuentran la sección del piso que ha atraído la atención de la lámpara. ¿Qué es lo que ves?
...
## Pantalla 1.2.1.1: Estudiar para el examen
**[Ruta estudiante]**
...
## Pantalla 1.2.1.1.1.2.1: Salir corriendo
...
## Pantalla 1.2.1.1.1.2.2: Quedarte a prestar atención
...
## Pantalla 1.2.1.1.1.2.1.1 / 1.2.1.1.1.2.1.2: Recorrer los pasillos de la facu
...
## Pantalla 1.2.2.1: Estudiar para el examen


## Pantalla 1.2.2.2: Trabajar en tu proyecto
