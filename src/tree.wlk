...
const quiz_examen_4 = new EstadoQuizWollok(imageID = "quiz-examen-4", auxiliar = 0, musica = [eminem, eminem])
...
const examen_4 = new Estado(imageID = "examen-4", audio = "apurate-1")
/** Examen't ending */
