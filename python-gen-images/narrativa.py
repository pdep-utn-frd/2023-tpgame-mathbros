...
lista = [
    ...
    ['Felicidades. Tienes más cultura que un recién nacido, pero no mucho más. Podría haber acertado más preguntas eligiendo al azar. En fin. No puedo decir que estoy decepcionado, ya que no esperaba nada de ti.\nDecides ir a buscar algo para tomar.', 'Café', 'Mate', 'fin_cuestionario.jfif'],
    ['¿No pudiste responder 7 preguntas correctamente? Y eso que eran sencillas... No está tan mal, pero no es motivo de celebración. Ni muy listo, ni muy tonto.\nDecides ir a buscar algo para tomar.', 'Café', 'Mate', 'fin_cuestionario.jfif'],
