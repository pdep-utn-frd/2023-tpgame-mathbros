      ...
      'Café', 'Mate', 'fin_cuestionario.jfif', 'resultado-4'],
        ...
        ['Tomar mate, la elección acertada. Comienzas a calentar agua en la pava. Pero aquí viene la pregunta crucial: ¿a qué temperatura?',
         '348 Kelvin', 'Hervir el agua', 'mate.jfif', 'mate'],
            ...
            ['El aire que respiras tiene su precio. Cada elección tomada tiene su precio. Todo tiene su precio. Y la acción de quemar el mate no es la excepción. De hecho, su precio es sorprendentemente alto.\nTen cuidado, hay vidas en juego.',
             '...', '...', 'cobrador.jfif', 'cobrador-1'],
            # ...
